...
const HomeAchievementsBox = ({ title, years, iconSrc }: AchievementsBoxProps) => {
  return (
    <div className="w-full h-[135px] max-w-[340px] mx-auto mt-[56px] bg-red-200 flex flex-col items-center justify-center shadow-lg shadow-gray-300">
      ...
      <p className="font-extrabold text-sm text-gray-dark">
        {title}
      </p>
    </div>
  )
